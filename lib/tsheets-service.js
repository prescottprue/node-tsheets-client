 ...
 * @type {Function}
 */
exports.getJobcodes = getJobcodes;
...
function getJobcodes(params, callback) {
  var validated_params,
      req_params;

  try {
    validated_params = internals.validateInput(params, 'get_jobcodes_validation_schema');
  }
  catch (e) {
    setImmediate(callback, e);
    return;
  ...
  req_params = internals.createGetJobcodeParams(validated_params);
  api_service.makeRequest(req_params, callback);
}
...
internals.createGetJobcodeParams = function(valid_params) {
  var params = {
    api_token: valid_params.api_token,
    method: 'get',
    endpoint: '/jobcodes',
