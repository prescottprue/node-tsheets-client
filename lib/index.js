...
exports.TSheets = exports.utils = exports.timesheets = undefined;
...
var TSheets = function () {
  ...
  _createClass(TSheets, [{
    ...
    key: 'reportTime',
    value: function reportTime(reportData) {
      return (0, _cruder2.default)('/timesheets', reportData);
    }
  }, {
    key: 'getTimesheets',
...
var timesheets = exports.timesheets = Object.assign({}, (0, _cruder2.default)('/timesheets', ['get', 'add', 'update', 'remove']));
